...
used to detect transitions between sections~\cite{serra2012unsupervised}. 
...
While the construction of \cref{pathmatrix} describes the intuition behind the combination of
local sequential connections and global repetition structure, it does not explicitly
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.9\textwidth]{figs/lowrank}
