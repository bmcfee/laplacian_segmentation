...
annotations as compared to functional annotations in Beatles and SALAMI (functional).
...
evaluate qualitatively different objectives~\cite{smith2013}.  Consequently, it may be
...
different pairs of metrics on SALAMI (functional).\label{mconfusion}}
\end{figure*}
