...
vertex connectivity~\cite{chung1997spectral}.  
...
An example of this type of analysis is depicted in \Cref{recurrence}.  Although the
first eigenvector is uninformative, the remaining bases clearly encode membership in
...
specified maximum number of structural components.
