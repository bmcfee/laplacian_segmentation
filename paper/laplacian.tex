...
\emph{large-scale}, and \emph{small-scale} annotations.
\end{description}
...
similar to that of Sch{\"o}rkhuber and Klapuri~\cite{schorkhuber2010constant}.  

CQT frames were mean-aggregated between detected beat events, and stacked using time-delay
...
$k$ set to $1 + \lceil 2\log_2 n\rceil$.
...
\Cref{results:beatles,results:salami:func,results:salami:large,results:salami:small}.  For each fixed value
...
annotations as compared to functional annotations in Beatles and SALAMI (func).
